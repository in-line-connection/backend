...
public class Initializer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		MedicalReport report1 = new MedicalReport("51", "CVA", "12-01-1990" ,"Female","14", "lmlmlmlmlmlml", "120/60", "60", "98%", "16", "15", "80",
				"Sinus Rhythm", "april");
		...
		MedicalReport report5 = new MedicalReport("53", "CVA", "12-01-1990" ,"Male","28", "lmlmlmlmlmlml", "120/60", "60", "98%", "16", "15", "80",
				"Sinus Rhythm", "april");
		...
		MedicalReport report10 = new MedicalReport("56", "CVA", "12-01-1990" ,"Male","13", "lmlmlmlmlmlml", "120/60", "60", "98%", "16", "15", "80",
				"Sinus Rhythm", "april");
